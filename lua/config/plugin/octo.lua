...
return {"pwntester/octo.nvim", cmd = "Octo", dependencies = {{"nvim-lua/plenary.nvim"}, {"nvim-tree/nvim-web-devicons"}, require("config.plugin.telescope")}, opts = {}, config = _1_}
