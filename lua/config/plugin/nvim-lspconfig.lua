...
return {"neovim/nvim-lspconfig", ft = {"fennel", "lua", "erlang", "elixir", "rust", "idris2", "cs"}, config = _13_, lazy = true, dependencies = {{"williamboman/mason-lspconfig.nvim", opts = {}, dependencies = {{"williamboman/mason.nvim", cmd = {"Mason", "MasonUpdate", "MasonInstall", "MasonUninstall", "MasonUninstallAll", "MasonLog"}, opts = {}}}}, {"ray-x/lsp_signature.nvim"}}}
